...
future_queue_length_train = 2 # future frame num input, default=4
future_pred_frame_num_train = 2 # future frame num pred training, default=4
future_queue_length_test = 2   # future frame num input, default=4
future_pred_frame_num_test = 2 # future frame num pred testing, default=4
