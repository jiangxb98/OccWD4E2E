...
sim_reward_nums = 4       # simulation reward head nums   # NC, DAC, EP, TTC, Comfortability
sim_head_type = 'WO_COMF'      # NC, DAC, EP, TTC, Comfortability, ALL, WO_NC, WO_DAC, WO_EP, WO_TTC, WO_COMF
