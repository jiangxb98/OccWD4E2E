...
# 添加蒸馏权重超参数
plan_distill_weight = dict(plan_query_distillation=1.0, plan_feat_distillation=1.0, traj_reward_distillation=1.0)  # [plan_query_distillation, plan_feat_distillation, traj_reward_distillation]
# 添加蒸馏开始epoch
distill_epoch_range = dict(plan_feat_distillation=[0, 12], plan_query_distillation=[0, 6], traj_reward_distillation=[6, 12])
