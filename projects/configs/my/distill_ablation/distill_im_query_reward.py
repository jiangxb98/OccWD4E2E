...
############################################################################################
# plan query & imitation reward蒸馏，使用gt occ(for reward model)，gt轨迹(for distillation)  #
############################################################################################
...
start_pred_occ_epoch = 3  # 从哪个epoch开始使用预测的occupancy来计算sim_reward, 20251017最优epoch是6
